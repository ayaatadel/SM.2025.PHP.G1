...
<form method="POST" action="{{ route('students.edit',$student->id) }}" class="w-75 m-auto border p-2">
  @csrf
  @method('put')
    {{-- Student Name --}}
    <div class="mb-3">
  ...
  {{-- Student Address --}}
    ...
    <input name="image" type="text" class="form-control" id="exampleInputImage" value="{{ $student->image }}"  >
  </div>
